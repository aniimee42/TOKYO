...
try: 
   ...
   TPARK7 = requests.get('https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/http.txt').text
   TPARK8 = requests.get('https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks4.txt').text
   TPARK9 = requests.get('https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks5.txt').text
...
proxx = open('.prox7.txt','w').write(TPARK7)
proxx = open('.prox8.txt','w').write(TPARK8)
proxx = open('.prox9.txt','w').write(TPARK9)
a = random.choice([TPARK1,TPARK2,TPARK3,TPARK4,TPARK5,TPARK6,TPARK7,TPARK8,TPARK9])
...
if TPARK1 in a:
 ...
 prox = open('.prox7.txt','r').read().splitlines()
elif TPARK8 in a:
 prox = open('.prox8.txt','r').read().splitlines()
elif TPARK9 in a:
 prox = open('.prox9.txt','r').read().splitlines()
try:
        import rich
except ImportError:
